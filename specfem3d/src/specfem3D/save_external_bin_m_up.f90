...
! anisotropy
  ...
  !magnoni
  !check
  if( filename == '/lscratch/users/magnoni/SPECFEM3D/trunk_update/in_out_files/DATABASES_MPI/mesh_files_m01/proc000000_external_mesh.bin' ) then
    print*,'NSPEC_AB            ', nspec
    print*,'NGLOB_AB            ', nglob
!     print*,'ibool               ', ibool
!     print*,'xstore              ', xstore_dummy
!     print*,'ystore              ', ystore_dummy
!     print*,'zstore              ', zstore_dummy
!     print*,'xix                 ', xixstore
!     print*,'xiy                 ', xiystore
!     print*,'xiz                 ', xizstore
!     print*,'etax                ', etaxstore
!     print*,'etay                ', etaystore
!     print*,'etaz                ', etazstore
!     print*,'gammax              ', gammaxstore
!     print*,'gammay              ', gammaystore
!     print*,'gammaz              ', gammazstore
!     print*,'jacobian            ', jacobianstore
